				...
				if(age.isEmpty() || income.isEmpty() || risk.isEmpty() || netWorth.isEmpty() || portfolioName.isEmpty())
				{
				 ...
				 int ageVal;
			        try {
			            ...
			            JOptionPane.showMessageDialog(portfolioBuilder.this,"Age must be a whole number between 1 and 120.","Invalid Age",JOptionPane.ERROR_MESSAGE);
			            return;
			        }
			        ...
			        try {
			            ...
			            JOptionPane.showMessageDialog(portfolioBuilder.this, "Income must be a valid positive number.",  "Invalid Income", JOptionPane.ERROR_MESSAGE);
			            return;
			        }
			        ...
			        try {
			            ...
			            JOptionPane.showMessageDialog(portfolioBuilder.this, "Net Worth must be a valid number greater than 0.", "Invalid Net Worth", JOptionPane.ERROR_MESSAGE);
			            return;
			        }
